...
//Klasa e cila miremban Listen e klienteve qe prej kyqjes se pare deri ne fund
    ...
    public void run()
    {
        ...
        while(keepListening)
        {
            try
            {
                ...
                System.out.println("Serveri po pranon: "+ message);
                ...
                if(header.equalsIgnoreCase("login"))
                {
                    ...
                    clientListener.clientStatus(name+": eshte kycur me IP adresen "+client.getInetAddress()+" dhe port numrin "+client.getPort());
                    String ip ="";
