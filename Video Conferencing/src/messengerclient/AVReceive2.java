...
/**Implementon komunikimin ne rrjet. 
 * Konkretisht ne kete klase pranohen video dhe audio permes metodave RTP
    ...
    {   
        ...
        {   
            ...
            {   
                ...
                {   
                    System.err.println("Deshtoi lidhja me adresen: " + sessions[i]);   
                    return false;   
                }   
           
                System.err.println("  - Fillo RTP sesionin per adresen: " + session.addr + " port: " + session.port + " ttl: " + session.ttl);   
...
(BufferControl)mgrs[i].getControl("javax.media.control.BufferControl");   
         ...
         {   
             System.err.println("Nuk mund te krijohet RTP Sessioni: " + e.getMessage());   
             return false;   
         }   
         ...
         {   
             ...
             {   
                 ...
                 {   
                     if (!dataReceived)   
                         System.err.println("  - Ne pritje te te dhenave RTP...");   
                     dataSync.wait(1000);   
                 }   
             }   
         }    
         ...
         if (!dataReceived)    
         {   
             System.err.println("Asnje nga te dhenat RTP nuk eshte pranuar.");   
             close();   
             return false;   
         }   
         return true;   
     ...
     {   
         ...
         {   
             ...
             System.err.println("  - Nje bashkebisedues sapo u lidh: " + p.getCNAME());   
         }   
     }   
     ...
     {   
         ...
         {   
             ...
             System.err.println("  - Eshte pranuar nje RTP PayloadChangeEvent.");   
         ...
         {   
             ...
             {   
                 ...
                 if (ctl != null)   
                 {   
                     System.err.println("  - U pranua nje RTP stream: " + ctl.getFormat());  

 
                 }    
                 else   
                     System.err.println("  - U pranua nje RTP stream");   
            
                 if (participant == null)   
                     System.err.println("     Derguesi i ketij stream ende nuk eshte identifikuar.");   
                 else    
                 {   
                     System.err.println("      Stream vjen nga: " + participant.getCNAME());    
                 }   
         ...
         {   
              ...
              {   
                 ...
                 // Find out the formats.   
                 RTPControl ctl = (RTPControl)ds.getControl("javax.media.rtp.RTPControl");   
                 System.err.println("  - Stream i meparshem i paidentifikuar  ");   
                 if (ctl != null)   
                     System.err.println("      " + ctl.getFormat());   
                 System.err.println("      tani eshte identifikuar dhe derguar si: " + participant.getCNAME());   
              }   
         }   
